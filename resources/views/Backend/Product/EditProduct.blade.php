        ...
        <form method="post" action="{{ route('admin.Product.update',['id'=>$product->id]) }}"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input id="feil" type="text" name="image" value="{{$product->image}}">
...
{{--                        @endforeach--}}
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="price" value="{{$product->price_sale}}" name="price"
                        placeholder="giá gốc ">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">giá sale</label>
                    <input type="number" class="form-control" id="price_sale" value="{{$product->price}}"
                        name="price_sale" placeholder="giá khuyến mại ">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" class="form-control" id="status" name="status" value="1"
                        {{($product->status==1)?'checked':''}} style="width: 10%;">
                </div>
                <div class="form-group">
                    <label for="description">Mô tả sản phẩm </label>
                    <textarea name="description" id="editor-ckeditor" rows="10"
                        cols="80">{{$product->description}}</textarea>
                </div>
            </div>
